...
#define ARCHI_L2_PRIV0_SIZE  8 * 1024

#define ARCHI_L2_PRIV1_ADDR  0x1c002000
#define ARCHI_L2_PRIV1_SIZE  8 * 1024

#define ARCHI_L2_SHARED_ADDR  0x1c004000
#define ARCHI_L2_SHARED_SIZE  48 * 1024
...
#define ARCHI_CLUSTER_GLOBAL_ADDR(cid)  (0xB0000000 + (cid)*ARCHI_CLUSTER_SIZE)
